...
1. 登录 MAS 并导航到 Manage UI 中的资产或位置页面：<br/>
    - 对于**资产**：（**Manage → Assets → Assets**）
    ![导航资产](img/view_meter_data_01.png) <br/>
    - 对于**位置**：（**Manage → Assets → Locations**）
    ![导航位置](img/view_meter_data_05.png) <br/>

2. 按名称搜索资产或位置并点击它以查看其仪表。
![导航资产](img/view_meter_data_02.png) <br/>

3. 在左侧面板中，点击 **Manage Meter Reading History**
![仪表读数](img/view_meter_data_03.png) <br/>

4. 根据仪表类型点击 **Characteristic and Gauge Meter Readings**，以查看所有仪表数据。
![仪表读数](img/view_meter_data_04.png) <br/>
