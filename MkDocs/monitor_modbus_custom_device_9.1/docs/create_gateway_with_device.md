...
您现在将看到新的托管网关，在网关列表和网关定义中都包含`受管`标签：
...
选择i550产品，选择`i550simulator`并点击`下一步`：</br>
...
查看设备汇总信息。点击`保存`：
![设备汇总信息](img/add_device_11.png)


</br>
您现在将看到新添加的设备成为新托管网关的一部分：
![设备已添加](img/add_device_12.png)</br></br>
